...
test_rule <- function(first, second, pages) {
  first_i  <- which(pages == first)  |> sort()
  second_i <- which(pages == second) |> sort()
...
The following section is brought to you by thinking, "Surely there's a graph algorithm for this", and also some wishful thinking about the completeness of the rules (prompted by the meaningfulness of the middle page).
